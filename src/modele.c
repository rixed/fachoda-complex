...
viondesc_s viondesc[NBNAVIONS] = {
	{"dewoitine",5,1000,1,0,0,50,55,2,0,0,1,.004,.65,.60,.06,.31,.0004,600,200000, {7,8,9} },
	{"corsair",0,5000,1,2,0,49,50,4,0,0,0,.006,.62,.56,.09,.34,.0003,800,500000, {24,25,23} },
	{"moshito",0,7000,2,4,1,45,46,4,1,1,0,.008,.60,.50,.08,.3,.0003,1000,300000, {42,44,38} },
	{"bogoplane",0,2000,1,0,0,23,24,1,0,0,1,.005,.65,.55,.07,.31,.00035,700,300000,{17,18,19}},
	{"spitflame",0,4000,1,0,0,29,30,4,0,0,0,.0052,.65,.51,.08,.33,.00025,1300,430000,{24,25,26}},
	{"snophill",3,800,1,0,0,31,32,1,0,0,1,.0034,.75,.70,.07,.31,.0005,500,170000,{26,27,28}}
};
nobjet_s nobjet[] = {
